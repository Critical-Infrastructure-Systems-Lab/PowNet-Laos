...
# Note
This model is based on PowNet v1.3, which is no longer developed. If you are interested in running an instance of PowNet for the Laotian power system, please check the [latest release](https://github.com/Critical-Infrastructure-Systems-Lab/PowNet) of PowNet (v2.0), which includes input data for this case study.
